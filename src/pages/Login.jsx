...
<source src="/images/istockphoto-1449327718-640_adpp_is.mp4" type="video/mp4"></source>
        </video>
...
.</p>
      <button  onClick={handleLoginWithGoogle}  className="btn ">Login With Google <img  className="max-w-[20px]" src="/images/search.png"/>
</button>
    </div>
  </div>
</div>
